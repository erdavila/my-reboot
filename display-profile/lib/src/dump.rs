...
use windows::Wdk::Graphics::Direct3D::D3DKMDT_VIDEO_SIGNAL_STANDARD;
use windows::Win32::Devices::Display::{
    ...
    QDC_ALL_PATHS, QDC_ONLY_ACTIVE_PATHS, QUERY_DISPLAY_CONFIG_FLAGS, SDC_APPLY, SDC_VALIDATE,
    SET_DISPLAY_CONFIG_FLAGS,
};
use windows::Win32::Foundation::{LUID, POINTL, RECTL};
use windows::Win32::Graphics::Gdi::DISPLAYCONFIG_PATH_SUPPORT_VIRTUAL_MODE;
